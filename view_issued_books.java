		...
		try
			{
				...
				ResultSet rs = stmt.executeQuery(s1);
					int i=0,j=0;
		String str[]={"Book_No","Student_Id","Student_Name","Contact"};
			Object obj[][]=new Object[10][6];
			
				while(rs.next())
				{
					obj[i][j++]=rs.getInt("Book_no");
					obj[i][j++]=rs.getInt("Student_Id");
					obj[i][j++]=rs.getString("Student_Name");
					obj[i][j++]=rs.getString("Contact");
					i++;
					j=0;
				}
